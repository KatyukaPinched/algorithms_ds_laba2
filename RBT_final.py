...
print("\nВысота дерева —", rbt.return_height())
rbt.print_depth()
rbt.print_width()
...
for i in range(1, 50001, 500):
    ...
    y_height.append(rbt.return_height())
    x_col_vo.append(i)
